...
from app.api import performance_signatures  # Import performance signatures API
...
app.include_router(performance_signatures.router)  # Add the performance signatures API
