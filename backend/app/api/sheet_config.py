...
async def create_configuration(
    request: CreateSheetConfigRequest,
...
async def get_available_sheets(
    ...
    try:
        ...
        logger.info(f"Available sheets requested with parameters: spreadsheet_id={spreadsheet_id}, event_key={event_key}, year={year}")
        ...
        return {
            "status": "error",
            "message": f"Error getting available sheets: {str(e)}"
        }