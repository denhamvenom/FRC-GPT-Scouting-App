// frontend/src/pages/PicklistNew/components/ProgressIndicator.tsx

import React, { useState, useEffect } from "react";
import { ProgressIndicatorProps, BatchProgressIndicatorProps } from "../types";
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-lg mx-auto my-8 px-4">
      ...
      <div className="flex justify-between w-full text-sm text-gray-600 mt-1 mb-3">
        <span>
          Processing batch {batchInfo.current_batch} of {batchInfo.total_batches}
        </span>
